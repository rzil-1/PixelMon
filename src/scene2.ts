    ...
    create() {
        ...
        this.activePlayerPokemon = new playerPokemon({
            ...
            _pokemonDetails: {
                ...
                currentHp: POKEMON_DATA.PIKACHU.maxHp,
                maxHp: POKEMON_DATA.PIKACHU.maxHp,
                attackIds: POKEMON_DATA.PIKACHU.attackIds,
                baseAttack: POKEMON_DATA.PIKACHU.baseAttack,
                type: POKEMON_DATA.PIKACHU.type,
            },
        });
